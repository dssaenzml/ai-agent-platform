...
class TestChatInput:
    ...
    def test_chat_input_empty_query(self):
        ...
        chat_input = ChatInput(
            query="", chat_history=[], user_id="user123", session_id="session456"
        )
    ...
    def test_chat_input_optional_fields(self):
        ...
        chat_input = ChatInput(query="Test query", user_id="user123")
...
class TestFileInput:
    ...
    def test_file_input_path_validation(self):
        ...
        for path in valid_paths:
            file_input = FileInput(
                file_path=path, user_id="user123", file_name="test.pdf"
            )
...
class TestFileOutput:
    ...
    def test_file_output_optional_fields(self):
        ...
        file_output = FileOutput(result="Basic result", file_name="test.pdf")
...
class TestStreamOutput:
    ...
    def test_valid_stream_output(self):
        ...
        stream_output = StreamOutput(
            token="Hello", session_id="session456", is_final=False
        )
    ...
    def test_stream_output_final_token(self):
        ...
        stream_output = StreamOutput(token="", session_id="session456", is_final=True)
    ...
    def test_stream_output_token_types(self, token, expected):
        ...
        stream_output = StreamOutput(
            token=token, session_id="session456", is_final=False
        )
