...
class SoWType(BaseModel):
    ...
    sow_type: str = Field(
        description=
        "The scope of work type requested, one of the following: "
...
class ConsultancyServicesSoWDetails(BaseModel):
    ...
    preamble: str = Field(
        description=
        "This section should include a brief high-level introduction "
        "about the project such as location, objectives and parties "
        "involved in execution."
    )
    general_sow: str = Field(
        description=
        "This section should include an overview of general scope of "
    ...
    deliverables: str = Field(
        description=
        "This section should an exhaustive list of deliverables that "
    ...
    exclusions: str = Field(
        description=
        "This section should include, for the sake of clarity, items "
    ...
    optional_scope: str = Field(
        description=
        "This section should optional scope items, which may be "
        "instructed later at Employer's discretion."
    )
    facilities_by_employer: str = Field(
        description=
        "This section should include an exhaustive list and description "
...
class SendEmail(BaseModel):
    ...
    binary_score: str = Field(
        description=
        "Email needs to be sent, 'yes' or 'no'"
    )
