...
class DevelopmentConfig(Config):
    ...
    AZURE_OPENAI_IMG_GEN_DEPLOYMENT_NAME=os.getenv("AZURE_OPENAI_IMG_GEN_DEPLOYMENT_NAME")
    ...
    AZURE_OPENAI_AUDIO_LLM_DEPLOYMENT_NAME=os.getenv("AZURE_OPENAI_AUDIO_LLM_DEPLOYMENT_NAME")
