...
from ...chain.agent_general.avatar_qa_bot import conversational_chain as avatar_chain
from ...chain.agent_general.avatar_qa_bot import (
    conversational_chain_stream as avatar_chain_stream,
)
from ...chain.agent_general.process_kb_file import process_file as process_kb_file
from ...chain.agent_general.process_kb_file import (
    process_file_stream as process_kb_file_stream,
)
from ...chain.agent_general.process_user_file import process_file as process_user_file
...
if _PYDANTIC_MAJOR_VERSION == 2:
    ...
    ) -> avatar_process_kb_file_api_handler.InvokeResponse:
        """
        API endpoint used only for single static response from the chain.
        """
        raise NotImplementedError(
    ...
    ) -> avatar_process_kb_file_api_handler.BatchResponse:
        """
        API endpoint used only for batch static response from the chain.
        """
        raise NotImplementedError(
    ...
    ) -> avatar_purge_kb_files_api_handler.InvokeResponse:
        """
        API endpoint used only for single static response from the chain.
        """
        raise NotImplementedError(
    ...
    ) -> avatar_rag_api_handler.InvokeResponse:
        """
        API endpoint used only for single static response from the bot.
        """
        raise NotImplementedError(
    ...
    ) -> avatar_rag_api_handler.BatchResponse:
        """
        API endpoint used only for batch static response from the bot.
        """
        raise NotImplementedError(
