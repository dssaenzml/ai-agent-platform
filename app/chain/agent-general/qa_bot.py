...
from ...graph.agent_general.graph_bot import app as chat_agent
from ...memory.session_factory import create_session_factory
from ...model.agent_general.bot_model import (ConversationInputChat,
    ...
    (
        {
            ...
            "doc_ids": itemgetter("doc_ids"),
            "user_id": itemgetter("username"),
        }
        ...
        | {
            ...
            "image_blob_url": itemgetter_with_default("image_blob_url", None),
            "pdf_blob_url": itemgetter_with_default("pdf_blob_url", None),
            "pdf_filename": itemgetter_with_default("pdf_filename", None),
        }
    )
    .with_types(
