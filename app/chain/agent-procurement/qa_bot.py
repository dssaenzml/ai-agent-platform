...
from ...graph.agent_procurement.graph_bot import (
    app as chat_agent
    )
...
conversational_chain = (
    ...
    | 
    {
       ...
       "sow_filename": itemgetter_with_default("sow_filename", None), 
       "sow_blob_url": itemgetter_with_default("sow_blob_url", None), 
    }
).with_types(
